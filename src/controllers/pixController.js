...
const pix = require('./processPixIndividual');




module.exports = {
    async pixCheck(req, res) {
        ...
        const result_dataClient = await NumberAcounts(result_cpf_cnpj.cpf_or_cnpj)   //CONULTANDO NO BANDO DE DADOS DO INTEGRATOR
        ...
        console.log(result_dataClient.dataDB[0].codcli)
        const fat = await pix(result_dataClient.dataDB[0].codcli)
