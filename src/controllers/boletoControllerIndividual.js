...
const boletosIndividual = require('../controllers/processBoletoIndividual');
...
module.exports = {
    async boletoCheck(req, res) {
        ...
        let result_dataClient = await NumberAcounts(result_cpf_cnpj.cpf_or_cnpj)   //CONULTANDO NO BANDO DE DADOS DO INTEGRATOR
        ...
        const fat = await boletosIndividual(result_dataClient.dataDB[0].codcli)
